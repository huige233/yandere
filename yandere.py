...
def save_img(img_url,file_name,file_path=r'D:\p\save'):
    ...
    try:
        ...
        filename = '{}{}{}'.format(file_path,os.sep,file_name)  # 拼接图片名（包含路径）
...
for page in range(4,8): # 填入爬取1-8页
    time.sleep(3)
    url = "https://yande.re/post?page=" + str(page) + "&amp;tags=kantoku"   #这个tag自己填写(lose,touhou,gayarou,kantoku)
